...
class GlobalConstant {
	 ...
	 @SuppressWarnings("serial")
		final static Map<String, String> ACTION_HANDLER_CONFIG_MAP = new HashMap<String, String>() {
	       { 
	    	 put("CUSTOM_METADATA_TYPE", "RunlistAutomation.CustomMetadataTypeActionHandler");
	        ...
	        // put("BATCH_JOB_ABORT","RunlistAutomation.ApexBatchJobAbortHandler");
		     ...
		     put("PAGE_LAYOUT_ADD_FIELD","RunlistAutomation.PageLayoutFieldAdditionExecutionHandler");
	       	}
		};
