...
public class RunlisExecutionOperationManager {
    
   
    public static void main(String[] args) {
    	RunlisExecutionOperationManager re = new RunlisExecutionOperationManager();
    	re.start();
    }
    public void start() {
        try {
            ...
            String queryString  = "SELECT Id,Name,Action__c,Action_Type__c,Page_Layout__c, Profile__c,Record_Type__c, Object__c, ObjectName__c, Activity_Type__c,Apex_Code__c "
