 ...
 */
public class PageLayoutFieldAdditionExecutionHandler extends MetadataAPIConnector implements IrunlistItemActionHandler {

    private MetadataConnection metadataConnection;

    private static final String ZIP_FILE_RETRIEVE = "components.zip";
    private static final String ZIP_FILE_DEPLOY = "componentsOutput.zip";
   ...
   // private BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
    ...
    /*public static void main(String[] args) throws Exception {
    	PageLayoutFieldAdditionExecutionHandler sample = new PageLayoutFieldAdditionExecutionHandler();
        sample.run();
    }*/

    public PageLayoutFieldAdditionExecutionHandler() {
    }
    
    @Override
	public void execute(RunlistItemWrapper runlistItem, AuthInfo authInfo) throws Exception {
		
		this.metadataConnection = doMetadataConnect(authInfo);
	       
        buildPackageXml();
        retrieveZip();
        PageLayoutModification.addFieldOnPageLayout(runlistItem.pageLayout,"Account Information",runlistItem.addRemoveField,runlistItem.priorField);
        deployZip();
   ...
   /* private void run() throws Exception {
     ...
     /*   String choice = getUsersChoice();
        while (choice != null && !choice.equals("99")) {
            if (choice.equals("1")) {
            	CreateXmlFileDemo.buildPackageXml();
                retrieveZip();
                PageLayoutModification.addFieldOnPageLayout();
                deployZip();
  ...
  /*  private String getUsersChoice() throws IOException {
    ...
    private void deployZip() throws Exception {
        ...
        System.out.println("The file " + ZIP_FILE_DEPLOY + " was successfully deployed\n");
    }
    ...
    */
    private byte[] readZipFile() throws Exception {
        ...
        File zipFile = new File(ZIP_FILE_DEPLOY);
    ...
    */
    ...
    private void retrieveZip() throws Exception {
        ...
        if (result.getStatus() == RetrieveStatus.Failed) {
	        ...
	        File resultsFile = new File(ZIP_FILE_RETRIEVE);
    ...
    public static void buildPackageXml() {
        ...
        try {
           ...
           Attr attrParent = doc.createAttribute("xmlns");
           attrParent.setValue("http://soap.sforce.com/2006/04/metadata");
           rootElement.setAttributeNode(attrParent);
           doc.appendChild(rootElement);

           // supercars element
           Element supercar = doc.createElement("types");
           rootElement.appendChild(supercar);


           // carname element
           Element carname = doc.createElement("members");
           carname.appendChild(doc.createTextNode("Account-Account %28Marketing%29 Layout"));
           supercar.appendChild(carname);

           Element carname1 = doc.createElement("name");
           carname1.appendChild(doc.createTextNode("Layout"));
           supercar.appendChild(carname1);

           Element version = doc.createElement("version");
           version.appendChild(doc.createTextNode("45.0"));
